      ...
      <div class="modal-wrapper">
        <div class="modal-container">
          ...
          <div v-if="type === 'user'" class="modal-body">
            ...
            Saldo:
            <input class="input" type="number" placeholder="Saldo" v-model="valueUser">
          </div>
...
export default {
  ...
  mounted() {
    ...
    if(this.$props.type === 'user'){
      ...
      this.valueUser= this.$props.data.saldo
    } else {
  ...
  methods: {
    ...
    editPerson(){
      debugger
      return api.put("https://back-coin.herokuapp.com/users", {id: this.$props.data.id, nome: this.nameUser, senha: this.password, email: this.email, saldo: this.valueUser})
        .then((res) => {
          debugger
          if (res.data.success) {
            console.log(res.data.message)
